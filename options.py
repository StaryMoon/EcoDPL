...
parser.add_argument('--epochs', type=int, default=240, help='maximum number of epochs to train the total model.')
...
parser.add_argument('--task_id', type=int, default=0, 
                        help='Task ID for continual learning (0 for task0, 1 for task1)')
...
parser.add_argument("--ckpt_dir",type=str,default="train_ckpt_EWC",help = "Name of the Directory where the checkpoint is to be saved")
